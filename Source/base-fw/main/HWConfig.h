...
// Two existing boards
#define BOARD_PROTOTYPE_0   (1)
#define BOARD_PCB_V1        (2)

#define BOARD_SELECT (BOARD_PCB_V1)

#if BOARD_SELECT == BOARD_PROTOTYPE_0
...
// Servo-motor
#define HWCONFIG_SERVOMOTOR_PIN GPIO_NUM_21

// Ramp led control
#define HWCONFIG_RAMPLED_PIN GPIO_NUM_22

// External button (input only)
#define HWCONFIG_UIBUTTON_PIN GPIO_NUM_39
...
// I2C
#define HWCONFIG_I2C_ISPRESENT (0)
...
#elif BOARD_SELECT == BOARD_PCB_V1
