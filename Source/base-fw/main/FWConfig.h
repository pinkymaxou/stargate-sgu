...
#define FWCONFIG_RINGCONTROL_STACKSIZE 4500
#define FWCONFIG_RINGCONTROL_PRIORITY_DEFAULT (tskIDLE_PRIORITY+1)
#define FWCONFIG_RINGCONTROL_COREID 1
...
// Mp3 music player
#define FWCONFIG_MP3PLAYER_PORT_NUM UART_NUM_2
#define FWCONFIG_MP3PLAYER_BUFFSIZE 128
#define FWCONFIG_MP3PLAYER_BAUDRATE 115200
