...
static NVSJSON_SSettingEntry m_sConfigEntries[SETTINGS_EENTRY_Count] =
{
    ...
    [SETTINGS_EENTRY_WormholeMaxBrightness] =   NVSJSON_INITINT32_RNG("WH.MaxBright",    "Maximum brightness for wormhole leds. (Warning: can cause voltage drop)", 200, 0, 255, NVSJSON_EFLAGS_None),
