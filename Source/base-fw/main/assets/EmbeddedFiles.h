...
typedef enum
{
    ...
    EF_EFILE_CSS_SIDENAV_CSS = 6,    /*!< @brief File: css/sidenav.css (size: 557  B) */
    EF_EFILE_CSS_TOP_MENU_CSS = 7,    /*!< @brief File: css/top-menu.css (size: 440  B) */
    ...
    EF_EFILE_JS_APP_JS = 17,    /*!< @brief File: js/app.js (size: 4 KB) */
