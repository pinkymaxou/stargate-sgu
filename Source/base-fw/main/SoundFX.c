...
{
    [SOUNDFX_EFILE_1_beginroll_mp3] = SOUNDFX_SFILE_INIT("1_beginroll.mp3", 1250, ""),
    [SOUNDFX_EFILE_2_chevlck_wav]   = SOUNDFX_SFILE_INIT("2_chevlck.wav", 750, ""),
    [SOUNDFX_EFILE_3_chevlck2_wav]  = SOUNDFX_SFILE_INIT("3_chevlck2.wav", 1200, ""),
    [SOUNDFX_EFILE_4_gateclos_mp3]  = SOUNDFX_SFILE_INIT("4_gateclos.mp3", 2500, ""),
    [SOUNDFX_EFILE_5_gateopen_mp3]  = SOUNDFX_SFILE_INIT("5_gateopen.mp3", 5000, ""),
    [SOUNDFX_EFILE_6_lggroll_mp3]   = SOUNDFX_SFILE_INIT("6_lggroll.mp3", 26500, ""),
    [SOUNDFX_EFILE_7_lockfail_wav]  = SOUNDFX_SFILE_INIT("7_lockfail.wav", 1000, ""),
    [SOUNDFX_EFILE_8_music1_mp3]    = SOUNDFX_SFILE_INIT("8_music1.mp3", 346000, ""),
    [SOUNDFX_EFILE_9_music2_mp3]    = SOUNDFX_SFILE_INIT("9_music2.mp3", 173000, ""),
    [SOUNDFX_EFILE_10_wormhole_wav]  = SOUNDFX_SFILE_INIT("10_wormhole.wav", 5319, ""),
};
